...
from acme.agents.jax.d4pg_next import config as d4pg_config
from acme.agents.jax.d4pg_next import learning
from acme.agents.jax.d4pg_next import networks as d4pg_networks
...
class D4PGBuilder(builders.ActorLearnerBuilder[d4pg_networks.D4PGNetworks,
  ...
  def make_learner(
    ...
    return learning.D4PGLearner(
        ...
        reset_frequency=int(320000/self._config.num_sgd_steps_per_step)
        )
