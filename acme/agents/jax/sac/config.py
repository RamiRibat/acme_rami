...
class SACConfig(normalization.InputNormalizerConfig):
	...
	min_replay_size: int = 10000 # -> limiter -> replay table
	max_replay_size: int = 1000000 # replay table (max_size)
	prefetch_size: int = 4 # ?
	samples_per_insert: float = 256 # --> batch-size
