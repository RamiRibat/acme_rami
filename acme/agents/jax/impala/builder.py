...
class IMPALABuilder(
	...
	def make_replay_tables(
		...
		extra_spec = policy.get_extras(dummy_actor_state)
	...
	def make_dataset_iterator(
		...
		# 	),
		# )
		# dataset = dataset.batch(batch_size_per_device, drop_remainder=True)
	...
	def make_adder( # == PPO.Learner.make_adder()
		self,
		replay_client: reverb.Client,
	...
	def make_policy(
		...
		actor_core = acting.get_actor_core(
			networks=networks,
